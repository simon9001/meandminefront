  ...
  return (
    <footer className="bg-forest-950 text-forest-300 mt-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="sm:col-span-2 md:col-span-1">
              ...
              <div className="space-y-2.5">
                <a href="mailto:support@maschon.co.ke" className="flex items-center gap-2 text-sm text-forest-400 hover:text-white transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row justify-between items-center gap-3">
        <p className="text-xs text-forest-600">© {new Date().getFullYear()} Maschon Home. All rights reserved. Nairobi, Kenya.</p>
