...
export const metadata: Metadata = {
  ...
  description: 'Maschon Home Terms and Conditions — governing the use of our platform in Kenya.',
};
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="mt-4 text-sm text-bark-600 leading-relaxed bg-earth-50 border border-earth-200 rounded-2xl p-4">
            These Terms &amp; Conditions govern your use of the Maschon Home platform and constitute a
            legally binding agreement between you and Maschon Home in accordance with the laws of Kenya,
        ...
        <div className="space-y-8 text-bark-700 text-sm leading-relaxed">
          ...
          <Section title="1. Acceptance of Terms">
            <p>By accessing or using the Maschon Home website, mobile site, or any associated service, you
            ...
            <p className="mt-3">Your continued use of Maschon Home after any amendment to these Terms constitutes your acceptance
          ...
          <Section title="3. Account Registration &amp; Security">
            ...
            <ul className="list-disc pl-5 space-y-1.5 mt-2">
              ...
              <li>Notify Maschon Home at <a href="mailto:support@maschon.co.ke" className="text-forest-700 underline">support@maschon.co.ke</a> of any suspected security breach.</li>
            </ul>
            <p className="mt-3">Maschon Home reserves the right to suspend or terminate accounts that violate these Terms or engage
          ...
          <Section title="4. Products &amp; Pricing">
            <ul className="list-disc pl-5 space-y-1.5">
              ...
              <li>Maschon Home reserves the right to change prices at any time without prior notice.</li>
          ...
          <Section title="6. Delivery &amp; Shipping">
            <ul className="list-disc pl-5 space-y-1.5">
              ...
              <li>Delivery timelines are estimates; Maschon Home is not liable for delays caused by third-party logistics providers, natural disasters, or government actions.</li>
          ...
          <Section title="7. Returns &amp; Refunds (Consumer Protection Act 2012)">
            ...
            <ul className="list-disc pl-5 space-y-1.5 mt-2">
              ...
              <li>To initiate a return, contact us at <a href="mailto:returns@maschon.co.ke" className="text-forest-700 underline">returns@maschon.co.ke</a> or via WhatsApp.</li>
            </ul>
          </Section>

          <Section title="8. Product Warranties">
            <p>Products sold by Maschon Home carry the manufacturer&apos;s warranty where applicable.
            Maschon Home does not extend its own warranty beyond that offered by the manufacturer unless
            otherwise stated in writing. Warranty claims must be submitted with proof of purchase.</p>
          </Section>

          <Section title="9. Intellectual Property">
            <p>All content on the Maschon Home platform — including but not limited to logos, photographs,
            product descriptions, and design elements — is owned by or licensed to Maschon Home and is
          ...
          <Section title="10. Prohibited Conduct">
            ...
            <ul className="list-disc pl-5 space-y-1.5 mt-2">
              ...
              <li>Engage in any conduct that could damage the reputation of Maschon Home.</li>
            </ul>
          </Section>

          <Section title="11. Limitation of Liability">
            <p>To the maximum extent permitted by Kenyan law, Maschon Home shall not be liable for any
          ...
          <Section title="14. Dispute Resolution">
            ...
            <a href="mailto:support@maschon.co.ke" className="text-forest-700 underline">support@maschon.co.ke</a> to
          ...
          <Section title="15. Amendments">
            <p>Maschon Home reserves the right to modify these Terms at any time. Changes take effect
          ...
          <Section title="16. Contact Information">
            ...
            <div className="mt-3 bg-white border border-bark-100 rounded-2xl p-5 space-y-2 text-sm">
              <p><strong>Maschon Home</strong></p>
              <p>Nairobi, Kenya</p>
              <p>Email: <a href="mailto:legal@maschon.co.ke" className="text-forest-700 underline">legal@maschon.co.ke</a></p>
